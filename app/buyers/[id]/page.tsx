...
async function fetchBuyer(id: string): Promise<Buyer> {
  ...
  return {
    ...
    description:
      "Kampala Grocers is a leading wholesale buyer of various agricultural products. We supply to major supermarkets and restaurants in Kampala and surrounding areas. We are always looking for reliable farmers to partner with for consistent supply of high-quality produce.",
  };
}
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {buyer.products.map((product) => (
                  <span
                    key={product}
                    className="bg-[#2C5F2D] text-white text-sm px-3 py-1 rounded-full"
                  >
                    {product}
                  </span>
                ))}
