    ...
    <div className="min-h-screen bg-[#F4F1DE] text-[#5E503F]">
      ...
      <main className="p-4 space-y-4">
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4">Popular Crops in Uganda</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p>The best times to plant crops in Uganda depend on the region and the specific crop. Here's a general guide:</p>
          <ul className="list-disc list-inside mt-2 space-y-2">
            <li><strong>March-May (First Rainy Season):</strong> Maize, Beans, Groundnuts</li>
            <li><strong>June-August (Dry Season):</strong> Cassava, Sweet Potatoes</li>
            <li><strong>September-November (Second Rainy Season):</strong> Maize, Beans, Millet</li>
            <li><strong>December-February (Dry Season):</strong> Vegetables, Fruits</li>
          </ul>
        </div>
      </main>
    </div>
...
function CropCard({ name, icon, waterNeeds, sunNeeds, temperature }: { name: string; icon: React.ReactNode; waterNeeds: string; sunNeeds: string; temperature: string }) {
  return (
