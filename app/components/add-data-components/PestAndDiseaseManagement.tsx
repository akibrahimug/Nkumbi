  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="commonPests">
          List common pests for this crop and how to identify and manage them
        </Label>
        <Textarea id="commonPests" {...register("commonPests")} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="commonDiseases">
          What diseases commonly affect this crop? Describe prevention and
