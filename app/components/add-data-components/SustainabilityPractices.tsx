  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="cropRotation">What crops should follow this one in rotation?</Label>
        <Textarea id="cropRotation" {...register('cropRotation')} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="organicFarming">What organic practices work best for this crop?</Label>
