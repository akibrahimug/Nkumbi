  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="harvestSigns">What are the signs that this crop is ready to harvest?</Label>
        <Textarea id="harvestSigns" {...register('harvestSigns')} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="harvestPractices">What are the best harvesting practices?</Label>
