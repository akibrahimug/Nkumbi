  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="marketTrends">
          What are the current market trends for this crop in Uganda? When are
      ...
      <div className="space-y-2">
        <Label htmlFor="buyerInformation">
          Who are the known buyers for this crop? What are their buying
          preferences?
        </Label>
