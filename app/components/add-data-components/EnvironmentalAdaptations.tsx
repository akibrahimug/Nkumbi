  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="climateTolerance">
          How does this crop react to different weather conditions in Uganda?
        </Label>
        <Textarea id="climateTolerance" {...register("climateTolerance")} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="soilRequirements">
          What are the ideal soil conditions (type, pH, nutrients) for this
          crop?
        </Label>
