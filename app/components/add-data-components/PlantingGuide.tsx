  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label htmlFor="bestPlantingTime">
          When is the best time to plant this crop in Uganda?
        </Label>
        <Textarea id="bestPlantingTime" {...register("bestPlantingTime")} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="soilPreparation">
          What soil preparation is needed?
        </Label>
        <Textarea id="soilPreparation" {...register("soilPreparation")} />
      </div>
      <div className="space-y-2">
        <Label htmlFor="optimalSpacing">
          What's the optimal spacing and depth for planting?
        </Label>
